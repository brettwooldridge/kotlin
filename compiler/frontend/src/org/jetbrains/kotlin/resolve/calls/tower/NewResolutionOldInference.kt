...
class NewResolutionOldInference(
    ...
    fun <D : CallableDescriptor> runResolution(
        ...
        val isBinaryRemOpeartor = isBinaryRemOperator(context.call)
        val nameToResolve = if (isBinaryRemOpeartor && !shouldUseOperatorRem)
        ...
        if (isBinaryRemOpeartor && shouldUseOperatorRem && emptyOrInapplicableCandidates) {
